...
Yo, ${datos.nombre}, identificado(a) con ${datos.tipoDocumento} No. ${datos.documento}, actuando en ejercicio del derecho fundamental de petición consagrado en el Artículo 23 de la constitución politica de Colombia, la Ley 1755 de 2015, respetuosamente presento ante ustedes la siguiente solicitud, con base en los siguientes:
